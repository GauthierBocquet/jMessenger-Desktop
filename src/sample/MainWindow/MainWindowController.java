...
import sample.MainWindow.AddFriends.AddFriendsWindowController;
import sample.MainWindow.Statistiques.StatistiquesWindows;
...
public class MainWindowController implements Initializable {
    ...
    public static MainWindowController principalWindowController;
    ...
    public void onClickQuitSalon() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/QuitSalon/QuitSalonWindows.fxml"));
    ...
    public void onClickAddUserSalon() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/AddUserToSalon/AddUserToSalonWindow.fxml"));
        Parent root = fxmlLoader.load();
        Stage mainWindowStage = new Stage();
    ...
    public void onClickExportXML() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/ExportXML/ExportXMLWindow.fxml"));
        Parent root = fxmlLoader.load();
        Stage mainWindowStage = new Stage();
        mainWindowStage.setTitle("Ajouter un utilisateur à un salon");
        mainWindowStage.setScene(new Scene(root, 350, 230));
    ...
    public void afficheStats() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/Statistiques/StatistiquesWindows.fxml"));
        Parent root = fxmlLoader.load();
        Stage mainWindowStage = new Stage();
    ...
    public void addFriends() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/AddFriends/AddFriendsWindow.fxml"));
        Parent root = fxmlLoader.load();
        Stage mainWindowStage = new Stage();
    ...
    public void addSalon() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/AddSalon/AddSalonWindow.fxml"));
        Parent root = fxmlLoader.load();
        Stage mainWindowStage = new Stage();
    ...
    private static void createMainWindow() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(RegisterController.class.getResource("../MainWindow/MainWindow.fxml"));
        Parent root = fxmlLoader.load();
        ...
        mainWindowStage.show();
        principalWindowController = fxmlLoader.<MainWindowController>getController();
        if(!isAlreadyRunning) {
