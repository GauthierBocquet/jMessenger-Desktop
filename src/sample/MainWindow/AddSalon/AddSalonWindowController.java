package sample.MainWindow.AddSalon;
...
public class AddSalonWindowController {
    ...
    public void createSalon() throws IOException {
        ...
        for(TextField textField : textFields){
            ...
            if(!textField.getText().isEmpty()) {
                ...
                if (Repository.isUserIdentifiantExist(textField.getText())) {
                    ...
                    if (textField.getText().equals(MainWindowController.userMain.getIdentifiant())) {
                        i=1;
                    }
                }
            }
        ...
        if (j==1){
            membres.add(MainWindowController.userMain.getIdentifiant());
            //addSalon(idSalon.getText(),membres,MainWindowController.userMain.getIdentifiant());
            Message message=new Message("ADD_SALON",Arrays.asList(idSalon.getText(),membres,MainWindowController.userMain.getIdentifiant()));
